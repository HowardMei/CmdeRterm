...
<key name="Software"> 
	<key name="ConEmu">
		<key name=".Vanilla" modified="2015-06-08 18:46:35" build="150513">
			...
			<value name="StartTasksName" type="string" data="{Cmder(cmd)}"/>
			...
			<value name="ClipboardClickPromptPosition" type="hex" data="01"/>
			...
			<value name="DefaultTerminalConfirm" type="hex" data="00"/>
			...
			<value name="Multi.NumberInCaption" type="hex" data="01"/>
			...
			<value name="HideCaptionAlwaysFrame" type="hex" data="03"/>
			...
			<value name="CmdOutputCP" type="dword" data="00000002"/>
			<value name="ComSpec.Type" type="hex" data="00"/>
			<value name="ComSpec.Bits" type="hex" data="00"/>
			<value name="ComSpec.UpdateEnv" type="hex" data="01"/>
			...
			<value name="ClipboardConfirmLonger" type="dword" data="00000320"/>
			...
			<value name="FixFarBordersRanges" type="string" data="2E80-9FC3;AC00-D7A3;F900-FAFF;FE30-FE4F;FF01-FF60;FFE0-FFE6;"/>
			...
			<value name="TabBtnDblClick" type="dword" data="00000004"/>
			...
			<value name="TabSkipWords" type="string" data="Administrator:|Администратор:|管理员:"/>
			...
			<value name="DesktopMode" type="hex" data="01"/>
			...
			<key name="HotKeys" modified="2015-06-08 18:27:10" build="150513">
				...
				<value name="MinimizeRestore" type="dword" data="00000000"/>
				...
				<value name="ForcedFullScreen" type="dword" data="00000000"/>
			...
			<key name="Tasks" modified="2015-06-08 18:27:10" build="150513">
				...
				<key name="Task1" modified="2015-06-08 18:27:10" build="150513">
					...
					<value name="GuiArgs" type="string" data="/icon &quot;%CMDER_ROOT%\icons\cmder.ico&quot; /single"/>
					<value name="Cmd1" type="string" data="cmd /k &quot;%ConEmuDir%\..\init.bat&quot;  -new_console:d:%CMDER_ROOT%\home"/>
				...
				<key name="Task2" modified="2015-06-08 18:27:10" build="150513">
					...
					<value name="Hotkey" type="dword" data="00000000"/>
					<value name="GuiArgs" type="string" data="/icon &quot;%CMDER_ROOT%\icons\cmder.ico&quot; /single"/>
					<value name="Cmd1" type="string" data="&quot;%CMDER_ROOT%\vendor\msysgit\bin\bash.exe&quot; --login -i"/>
					<value name="Active" type="dword" data="00000000"/>
					<value name="Count" type="dword" data="00000001"/>
				</key>
				...
				<key name="&lt;Startup&gt;" modified="2015-06-08 14:37:17" build="150513">
					<value name="GuiArgs" type="string" data=""/>
					<value name="Cmd1" type="string" data="&gt;* -cur_console:d:D:\mucmder\etc -cur_console:C:D:\Greens\CmdeRterm\vendor\conemu-maximus5\..\..\icons\cmder.ico cmd /k &quot;%ConEmuDir%\..\init.bat&quot;"/>
					<value name="Active" type="dword" data="00000001"/>
					<value name="Count" type="dword" data="00000001"/>
				</key>
			</key>
